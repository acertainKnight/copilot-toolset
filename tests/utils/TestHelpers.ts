 ...
 */
// Disabled - ServerConfig type no longer exists
...
export function createMockMemoryStats(overrides: Partial<MemoryStats> = {}): MemoryStats {
  const defaults: MemoryStats = {
    ...
    storage_locations: {
      core: 'Global SQLite Database',
      warm: 'Global SQLite Database',
      cold: 'Global SQLite Database',
      project: 'Global SQLite Database'
    }
  };
